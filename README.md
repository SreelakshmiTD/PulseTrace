...
---
## 📊 End-to-End RCA Output

PulseTrace was executed on a real log file inside the notebook UI.  
Below are the actual outputs generated by the multi-agent pipeline.

- **Schema Drift Detection**  
  <img src="run_results/schema_drift_output.png" width="600">

- **Anomaly & Invalid Row Detection**  
  <img src="run_results/anomaly_output.png" width="600">

- **A2A Message Trace**  
  <img src="run_results/a2a_trace_output.png" width="600">

- **Draft RCA Preview**  
  <img src="run_results/draft_rca.png" width="600">

- **Final Saved Report (JSON)**  
  <pre><code>{ ... }</code></pre>

- **Generated PDF Report**  
  👉 [Download PDF](run_results/sample_pdf.pdf)
---
